// Legacy translation option declaration.

#ifndef CTHUGHA_TRANSLATION_OPTION_H
#define CTHUGHA_TRANSLATION_OPTION_H
...
/** Applies startup policy for legacy translation generation. */
