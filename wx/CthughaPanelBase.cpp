...
CthughaPanelBase::CthughaPanelBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	fgSizer2->Add( m_flame_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_translation_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_image_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_object_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_waveTable_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_waveScale_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_soundProcessing_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_palette_choice, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_flashlight_checkBox, 0, wxALL, 5 );
	...
	fgSizer2->Add( m_maxFps_spinCtrl, 0, wxALL, 5 );
